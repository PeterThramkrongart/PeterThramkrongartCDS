...
#chunking data to smaller parts
...
# saving the data
#text_tibble %>% write_rds("data/text_tibble.rds")
```
...
#you need to have spacy and spacyr properly installed for this step
spacey_test<- spacy_parse(unlist(chunks[1:2]))#

spacey_test %>% glimpse()#this it what it looks like
...
spacy_lemmas <- read_csv("data/spacy_lemmas.csv")#loading the lemmas. This file is too big for github

#filtering the lemmas and collapsing the texts
# tic()
...
#doing the same thing with openNLP and textstem. It takes almost 2 hours to run
