...
raw_LDA %>% write_rds("rawLDA.rds")

raw_LDA <- read_rds("rawLDA.rds")
...
chunked_LDA %>% write_rds("chunkedLDA.rds")

chunked_LDA <- read_rds("chunkedLDA.rds")
...
lemmatized_tibble %>% write_csv("lemmatized_tibble.csv")

lemmatized_tibble <- read_csv("lemmatized_tibble.csv")
...
lemmatized_LDA %>% write_rds("lemmatizedLDA.rds")

lemmatized_LDA <- read_rds("lemmatizedLDA.rds")
...
spacy_lemmas %>% write_csv("spacy_lemmas.csv")


spacy_lemmas <- read_csv("spacy_lemmas.csv")
...
spacy_texts %>% write_csv("spacy_texts.csv")

spacy_texts <- read.csv("spacy_texts.csv")
...
spacy_LDA %>% saveRDS("spacyLDA.rds")
...
openNLP_texts %>%  write_csv("openNLP_texts.csv")

openNLP_texts <-  read_csv("openNLP_texts.csv")
...
openNLP_LDA %>% saveRDS("openNLP_LDA.rds")

openNLP_LDA <- read_rds("openNLP_LDA.rds")
